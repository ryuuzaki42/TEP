...
\begin{frame}[fragile]{União de conjunto disjuntos}
    ...
    \begin{itemize}
        ...
        \item Caso contrário considere, sem perda de generalidade, que o número de nós da árvore 
            que contém $x$ seja maior ou igual que o número de nós da árvore que contém $y$
